...
@Service
public class BuscarMensagensRecebidasEEnviadasService {
	@Autowired
	...
	public Page<Mensagem> buscar(String username1, String username2, String conteudo, int pagina) {
        ...
        Page<Mensagem> mensagens = mensagemRepository.queryMensagensRecebidasEEnviadas(username1, username2, conteudo, PageRequest.of(pagina, 10));
