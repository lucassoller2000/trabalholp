...
@Service
public class BuscarMensagensPorDestinatarioService {
	@Autowired
	...
	public Page<Mensagem> buscar(String username, String conteudo, int pagina) {
        ...
        Page<Mensagem> mensagens = mensagemRepository.queryByDestinatario(username, conteudo, PageRequest.of(pagina, 10));
