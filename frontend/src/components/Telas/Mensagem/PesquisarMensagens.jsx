...
export default class MostrarTodasMensagens extends React.Component {
    ...
    loadMensagens(){
        MensagemService.buscarTodasMensagensDoUsuarioComConteudo(this.props.match.params.conteudo, this.state.paginaAtual+1)
        .then(resp =>{
            this.setState({
    ...
    loadMensagensAnteriores(){
        MensagemService.buscarTodasMensagensDoUsuario(this.state.paginaAtual-1)
        .then(resp =>{
